...
Assemble.prototype.defaultEngines = function() {
  ...
  this.engine('hbs', require('./engine/handlebars'), {destExt: '.html'});
  this.engine('md', require('./engine/handlebars'), {destExt: '.html'});
};
...
Assemble.prototype.engine = function (ext, fn, options) {
  ...
  var e = this.engines.register(ext, fn, options);
  _.extend(this.cache.engines, e.cache);
