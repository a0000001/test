...
Assemble.prototype.defaultEngines = function() {
  ...
  this.engine('hbs', {destExt: '.html'}, require('./engine/handlebars'));
  this.engine('md', {destExt: '.html'}, require('./engine/handlebars'));
};
...
Assemble.prototype.engine = function (ext, options, fn) {
  ...
  var e = this.engines.register(ext, options, fn);
  this.cache.engines[ext] = this.engines.get(ext);
