...
/**
 * Generate a destination path based on the given params.
 *
 * @param   {String}  src       The source filepath
 * @param   {String}  dest      The dest filepath
 * @param   {Boolean}  expanded Have filepath patterns been expanded?
 * @param   {String}  options   The source filepath
 * @return  {String}            The source filepath
 */
